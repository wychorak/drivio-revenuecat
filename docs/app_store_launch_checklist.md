...
2. **Firebase backend:** najpierw ustawić sekret RevenueCat i wdrożyć Functions, a następnie reguły i indeksy. Polecenie: `firebase deploy --only functions,firestore:rules,firestore:indexes,storage --project <FIREBASE_PROJECT_ID>`.
