...
- iOS bundle identifier changed from `com.example.drivio` to `com.drivio.app`.
...
- Create the Apple Developer App ID for `com.drivio.app`.
...
- Enable Sign in with Apple for App ID com.drivio.app and in Firebase Authentication using Apple key ID 6D43VGP33F (driviokey).
